...
```
     ...
     <input type="file" id="files-ba225039-9139-4afc-afd9-4906e236755b" name="files[]" multiple disabled
        style="border:none" />
     <output id="result-ba225039-9139-4afc-afd9-4906e236755b">
...
```
  ...
  <div id="df-e385620f-472a-489d-8a32-e7f84d9741c1">
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-e385620f-472a-489d-8a32-e7f84d9741c1')"
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-e385620f-472a-489d-8a32-e7f84d9741c1 button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-e385620f-472a-489d-8a32-e7f84d9741c1');
          const dataTable =
...
```
  ...
  <div id="df-2cdf70ab-4e21-4871-8ff8-42abcb1d2901">
    <div class="colab-df-container">
      <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
...
<p>5 rows × 41 columns</p>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-2cdf70ab-4e21-4871-8ff8-42abcb1d2901')"
              title="Convert this dataframe to an interactive table."
              style="display:none;">
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-2cdf70ab-4e21-4871-8ff8-42abcb1d2901 button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-2cdf70ab-4e21-4871-8ff8-42abcb1d2901');
          const dataTable =
            await google.colab.kernel.invokeFunction('convertToInteractive',
                                                     [key], {});
          if (!dataTable) return;
...
```
  ...
  <div id="df-daaed3f0-2b29-4d1f-9933-daefc7c72083">
    <div class="colab-df-container">
      <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
...
<p>1213878 rows × 4 columns</p>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-daaed3f0-2b29-4d1f-9933-daefc7c72083')"
              title="Convert this dataframe to an interactive table."
              style="display:none;">
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-daaed3f0-2b29-4d1f-9933-daefc7c72083 button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-daaed3f0-2b29-4d1f-9933-daefc7c72083');
          const dataTable =
            await google.colab.kernel.invokeFunction('convertToInteractive',
                                                     [key], {});
          if (!dataTable) return;
...
```
  ...
  <div id="df-525a8e60-7ea5-4ff3-ae0b-ca1295022baf">
    <div class="colab-df-container">
      <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
...
<p>10 rows × 51 columns</p>
      ...
      <button class="colab-df-convert" onclick="convertToInteractive('df-525a8e60-7ea5-4ff3-ae0b-ca1295022baf')"
              title="Convert this dataframe to an interactive table."
              style="display:none;">
  ...
  <style>
    ...
    [theme=dark] .colab-df-convert:hover {
      ...
      <script>
        const buttonEl =
          document.querySelector('#df-525a8e60-7ea5-4ff3-ae0b-ca1295022baf button.colab-df-convert');
        buttonEl.style.display =
          google.colab.kernel.accessAllowed ? 'block' : 'none';

        async function convertToInteractive(key) {
          const element = document.querySelector('#df-525a8e60-7ea5-4ff3-ae0b-ca1295022baf');
          const dataTable =
            await google.colab.kernel.invokeFunction('convertToInteractive',
                                                     [key], {});
          if (!dataTable) return;
